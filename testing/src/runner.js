...
exports.Runner = {
  ...
  */
  ...
  begin: function() {
    ...
    plan.delegate = this;
    plan.run();
    } else console.error("NO PLAN!!!");
  },
  
  planDidBegin: function(plan) {
    console.log("Plan begun.");
  },
  ...
  planDidRecord: function(plan, module, test, assertions, timings) {
    ...
    if (clean=="clean") console.log(name);
